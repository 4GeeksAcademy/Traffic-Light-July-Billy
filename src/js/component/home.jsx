...
const [ green , setGreen ] = useState("green")
	...
	return (
		<div className="container" style={{justifyContent: 'center'}}>
			<div className="topPost mx-auto" style={{width: '16px', height: '118px', backgroundColor: 'black'}}>#</div>
			<div className="lightBox mx-auto border rounded p-2" style={{width: '100px', height: '250px', backgroundColor: 'black'}}>
